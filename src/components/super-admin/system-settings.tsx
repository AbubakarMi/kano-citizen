...
import { Settings, Vote, Percent } from "lucide-react";
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Configure system-wide parameters and settings for the Kano Citizens' Voice platform.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <div className="space-y-4 p-4 border rounded-lg">
                 ...
                 <div className="space-y-4 p-4 border rounded-lg">
                    <h3 className="font-semibold flex items-center gap-2"><Percent className="h-5 w-5" /> Satisfaction Score</h3>
                    <div className="flex items-center justify-between">
                        <Label htmlFor="score-weighting" className="flex flex-col gap-1">
                            <span>Completed Directive Weight</span>
                            <span className="font-normal text-muted-foreground text-xs">The weighting of completed directives in the satisfaction score.</span>
                        </Label>
                        <Input id="score-weighting" type="number" defaultValue="70" className="w-24" />
                    </div>
                 </div>
            </CardContent>
            <CardFooter>
